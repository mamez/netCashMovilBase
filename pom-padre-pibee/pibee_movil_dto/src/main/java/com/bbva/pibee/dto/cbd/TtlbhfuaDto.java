...
public class TtlbhfuaDto {
	...
	private String FEC_ACCIO;
	
	@Column(name="COD_USUFIRMA")
	private String COD_USUSFIRMA;
	...
	public String getFEC_ACCIO() {
		return FEC_ACCIO;
	}

	public void setFEC_ACCIO(String fEC_ACCIO) {
		FEC_ACCIO = fEC_ACCIO;
	}

	public String getCOD_USUSFIRMA() {
		return COD_USUSFIRMA;
	}

	public void setCOD_USUSFIRMA(String cOD_USUSFIRMA) {
		COD_USUSFIRMA = cOD_USUSFIRMA;
	}
	...
	public String getFEC_ACCION() {
		return FEC_ACCION;
	}

	public void setFEC_ACCION(String fEC_ACCION) {
