 ...
 * 
 * @author Grupo cmc
 * Clase para control de errores en capa de base de datos
 */
public class BbvaClientCbdException extends Exception{
	...
	public BbvaClientCbdException(CodClientException cod){
		LogNetCashMovil.logErrorPibee("Instaciando error capturado BbvaClientCbdException");
	...
	public BbvaClientCbdException(CodClientException cod, String codInterno, String msgInterno){
		LogNetCashMovil.logErrorPibee("Instaciando error capturado BbvaClientCbdException");
		LogNetCashMovil.logErrorPibee("Error Type     : "+cod);
		LogNetCashMovil.logErrorPibee("Codidigo Error : "+cod.cod());
	...
	public BbvaClientCbdException(CodClientException cod, Exception e){
		LogNetCashMovil.logErrorPibee("Instaciando error capturado BbvaClientCbdException");
		LogNetCashMovil.logErrorPibee("Error Type     : "+cod);
		LogNetCashMovil.logErrorPibee("Codidigo Error : "+cod.cod());
	...
	public  BbvaClientCbdException(Error error){
		LogNetCashMovil.logErrorPibee("Instaciando error capturado BbvaClientCbdException");
		if(error != null) {
