...
public class BbvaClientCwsException extends Exception{
	...
	public BbvaClientCwsException(CodClientException cod){
		LogNetCashMovil.logErrorPibee("Instaciando error capturado BbvaClientCwsException");
	...
	public BbvaClientCwsException(CodClientException cod, String codInterno, String msgInterno){
		LogNetCashMovil.logErrorPibee("Instaciando error capturado bvaClientCwsException");
		LogNetCashMovil.logErrorPibee("Error Type     : "+cod);
		LogNetCashMovil.logErrorPibee("Codidigo Error : "+cod.cod());
	...
	public BbvaClientCwsException(CodClientException cod, Exception e){
		LogNetCashMovil.logErrorPibee("Instaciando error capturado bvaClientCwsException");
		LogNetCashMovil.logErrorPibee("Error Type     : "+cod);
		LogNetCashMovil.logErrorPibee("Codidigo Error : "+cod.cod());
	...
	public  BbvaClientCwsException(Error error){
		LogNetCashMovil.logErrorPibee("Instaciando error capturado BbvaClientCwsException");
		if(error != null) {
